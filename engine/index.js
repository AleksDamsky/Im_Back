...
// Функции бывают: именованные, присвоенны перменной, анонимной, аргумент при вызове другой функции, значение свойства(метода) объекта

// функция -- это объект. console.dir() -- показывает структуру функции.

// функция состоит из: объявляющая конструкция, имя функции, параметры, тело функции, результат

// /*конструкция*/function /*имя*/ nameFunc/*параметры*/(a, b) { // начало тела функции
//     a = 3;
//     b = 4;
//     c = a + b;
//     return c; // результат
...
// после результата (return) тело функции перстает выполнять свои действия.

// Сиволы - это уникальные идентификаторы. В качестве ключей свойств используют их и строки. Ни логические выражания, ни числа.
